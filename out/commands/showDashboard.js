        ...
        panel.webview.onDidReceiveMessage(async (message) => {
            ...
            switch (message.command) {
                ...
                case 'toggleAutoCommit':
                    ...
                    panel.webview.html = dashboard_1.DashboardUI.getDashboardHtml(history1);
                    break;
                case 'toggleConfirmation':
                    ...
                    panel.webview.html = dashboard_1.DashboardUI.getDashboardHtml(history2);
                    break;
                case 'updateInterval':
                    ...
                    panel.webview.html = dashboard_1.DashboardUI.getDashboardHtml(history3);
                    break;
                case 'updateReminderInterval':
                    ...
                    panel.webview.html = dashboard_1.DashboardUI.getDashboardHtml(history4);
                    break;
                case 'updateCommitStyle':
                    ...
                    panel.webview.html = dashboard_1.DashboardUI.getDashboardHtml(history5);
                    break;
            }
        });
    }
