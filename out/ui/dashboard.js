...
class DashboardUI {
    static getDashboardHtml(commitHistory, extensionPath) {
            ...
            <div class="space-y-4">
                ...
                ${useAI ? `
                    <div class="flex justify-between items-center p-4 bg-gray-700 rounded-lg">
                        ...
                        <div class="flex items-center gap-3">
                            <span class="px-4 py-1 rounded-full text-sm font-semibold bg-blue-500 text-white">${constants_1.PROVIDER_NAMES[aiProvider] || aiProvider}</span>
                            ${hasApiKey ?
