...
class DefaultCommitGenerator {
     ...
     */
    static createNarrativeSummary(analysis, fileCount) {
     ...
     */
    static describeChanges(analysis, files) {
     ...
     */
    static createTechnicalSummary(analysis) {
        const lines = [];
     ...
     */
    static getMostCommonDirectory(analysis) {
     ...
     */
    static getMostCommonFileType(analysis) {
     ...
     */
    static getReadableFileTypePlural(ext) {
        const typeMap = {
            'ts': 'TypeScript files',
            'js': 'JavaScript files',
